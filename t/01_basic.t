...
is( gentooize_version( '1.6-TRIAL',   { lax => 1 } ), '1.600_pre001', 'x.y-TRIAL' );                                          # 53
is( gentooize_version( '1.67-TRIAL',  { lax => 1 } ), '1.670_pre001', 'x.yy-TRIAL' );                                         # 54
is( gentooize_version( '1.675-TRIAL', { lax => 1 } ), '1.675_pre001', 'x.yyy-TRIAL' );                                        # 55
is( gentooize_version( '1.6_01',      { lax => 1 } ), '1.600_pre010', 'x.y_z' );                                              # 56
is( gentooize_version( '1.67_01',     { lax => 1 } ), '1.670_pre010', 'x.yy_zz' );                                            # 57
is( gentooize_version( '1.675_01',    { lax => 1 } ), '1.675_pre010', 'x.yyy_zz' );                                           # 58

isnt( $e = exception { gentooize_version( '1.6_01_01', { lax => 1 } ) }, undef, 'x.y_z_a fails' );                            # 59
is( gentooize_version( '1.6.A',    { lax => 2 } ), '1.006.010',     'x.y.ASCII' );
is( gentooize_version( '1.6.AA',   { lax => 2 } ), '1.006.370',     'x.y.ASCII' );
is( gentooize_version( '1.6.AAA',  { lax => 2 } ), '1.006.370.010', 'x.y.ASCII' );
is( gentooize_version( '1.6.AAAA', { lax => 2 } ), '1.006.370.370', 'x.y.ASCII' );
